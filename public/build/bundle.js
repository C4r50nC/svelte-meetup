    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$1, 7, 4, 101);
    			attr_dev(div0, "class", "image svelte-wcfffe");
    			add_location(div0, file$1, 6, 2, 77);
    			attr_dev(p, "class", "svelte-wcfffe");
    			add_location(p, file$1, 11, 4, 161);
    			attr_dev(div1, "class", "content svelte-wcfffe");
    			add_location(div1, file$1, 10, 2, 135);
    			add_location(button0, file$1, 15, 4, 194);
    			add_location(button1, file$1, 16, 4, 228);
    			attr_dev(footer, "class", "svelte-wcfffe");
    			add_location(footer, file$1, 14, 2, 181);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(section, file, 28, 0, 701);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
